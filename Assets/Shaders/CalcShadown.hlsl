void CalcShadow(in float3 Normal, in float ToonRampSmoothness, in float3 ClipSpacePos, in float3 WorldPos, in float4 ToomRampTinting,
in float ToonRampOffset, out float3 ToonRampOutput, out float3 Direction)
{
        ...
        ToonRampOutput = light.color * (toonRamp + ToomRampTinting.rgb);
